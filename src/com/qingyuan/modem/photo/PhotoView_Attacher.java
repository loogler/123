 ...
 *
 */
public class PhotoView_Attacher implements PhotoView_I, View.OnTouchListener,
	...
	private static void setImageViewScaleTypeMatrix(ImageView imageView) {
		 ...
		 */
		if (null != imageView && !(imageView instanceof PhotoView_I)) {
	...
	private com.qingyuan.modem.photo.Util_GestureDetector mScaleDragDetector;
	...
	public PhotoView_Attacher(ImageView imageView) {
		...
		mScaleDragDetector = Util_GestureDetector_Versioned.newInstance(
		...
		mGestureDetector.setOnDoubleTapListener(new PhotoView_DefaultOnDoubleTapListener(
				this));
	...
	public void setOnDoubleTapListener(
		...
		if (newOnDoubleTapListener != null)
			...
			this.mGestureDetector
					.setOnDoubleTapListener(new PhotoView_DefaultOnDoubleTapListener(this));
	}
	...
	private class AnimatedZoomRunnable implements Runnable {
		...
		public void run() {
			...
			if (t < 1f) {
				PhotoView_Compat.postOnAnimation(imageView, this);
			}
		}
	...
	private class FlingRunnable implements Runnable {
		...
		private final Util_Scroller_Proxy mScroller;
		private int mCurrentX, mCurrentY;

		public FlingRunnable(Context context) {
			mScroller = Util_Scroller_Proxy.getScroller(context);
		}
