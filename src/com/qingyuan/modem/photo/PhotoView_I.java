...
public interface PhotoView_I {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoView_Attacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoView_Attacher.OnPhotoTapListener listener);
     ...
     */
    PhotoView_Attacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoView_Attacher.OnViewTapListener listener);
     ...
     */
    PhotoView_Attacher.OnViewTapListener getOnViewTapListener();
