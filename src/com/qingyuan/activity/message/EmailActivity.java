...
public class EmailActivity extends Activity implements
	...
	private List<UserInfo_Liker> userInfoList_Get = new ArrayList<EmailActivity.UserInfo_Liker>();
	private List<UserInfo_Liker> userInfoList_Sent = new ArrayList<EmailActivity.UserInfo_Liker>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pullListView_left.setOnRefreshListener(EmailActivity.this);
		pullListView_right.setOnRefreshListener(EmailActivity.this);
		...
		mViewPage = (ViewPager) btnLines.findViewById(R.id.viewpager_email);
	...
	class ListDataAdapter_Sent extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			loadImage(url, R.id.iv_recent_avatar, view);
			viewHoler.tv_recent_msg.setText(userInfoList_Get.get(position)
					.getTitle());
	...
	class XML_Parse_liker {
		...
		public List<UserInfo_Liker> parserLiker(String res) {
			...
			items = new ArrayList<EmailActivity.UserInfo_Liker>();
			try {
	...
	public void loadData(int dataType) {
		...
		List<UserInfo_Liker> list_info = new ArrayList<EmailActivity.UserInfo_Liker>();
			...
			if (res != null) {
				...
				if (json.getInt("code") == 1) {
					...
					EmailActivity.this.runOnUiThread(new Runnable() {
						public void run() {
							Toast.makeText(EmailActivity.this, jsonMsg,
