...
public class CommissionActivity extends Activity implements
	...
	private List<UserInfo_Commission> userInfoList_Get = new ArrayList<CommissionActivity.UserInfo_Commission>();
	private List<UserInfo_Commission> userInfoList_Sent = new ArrayList<CommissionActivity.UserInfo_Commission>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pullListView_left.setOnRefreshListener(CommissionActivity.this);
		pullListView_right.setOnRefreshListener(CommissionActivity.this);
	...
	class ListDataAdapter_Get extends BaseAdapter {
		...
		private List<UserInfo_Commission> userinfos;

		public ListDataAdapter_Get(Context context,
				List<UserInfo_Commission> userInfos) {
	...
	class XML_Parse_liker {
		...
		public List<UserInfo_Commission> parserLiker(String res) {
			List<UserInfo_Commission> items = null;
			UserInfo_Commission item = null;
			JSONObject json = null;
			items = new ArrayList<CommissionActivity.UserInfo_Commission>();
			try {
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 0: {
				List<UserInfo_Commission> mData = (List<UserInfo_Commission>) msg.obj;
	...
	public void loadData(int dataType) {
		...
		List<UserInfo_Commission> list_info = new ArrayList<CommissionActivity.UserInfo_Commission>();
		List<UserInfo_Commission> posters = null;
		...
		try {
			...
			if (res != null) {
				...
				if (json.getInt("code") == 1) {
					...
					for (UserInfo_Commission userInfo_Liker : posters) {
						list_info.add(userInfo_Liker);
					}
				} else if (json.getInt("code") == 10000) {
					CommissionActivity.this.runOnUiThread(new Runnable() {
						public void run() {
							Toast.makeText(CommissionActivity.this, jsonMsg,
