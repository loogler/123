...
public class Chat_EmotionApplication extends Application {
	...
	private static Chat_EmotionApplication mApplication;
	private Map<String, Integer> mFaceMap = new LinkedHashMap<String, Integer>();
	

	public synchronized static Chat_EmotionApplication getInstance() {
		return mApplication;
	}
